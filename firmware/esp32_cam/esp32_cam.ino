...
httpd_handle_t qc_stream_httpd = NULL;

static esp_err_t qc_stream_handler(httpd_req_t *req){
  camera_fb_t * fb = NULL;
  ...
  // IMPORTANT: Add CORS Header so the React App can access the stream
